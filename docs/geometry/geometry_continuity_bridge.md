...
diff --git a/docs/geometry/geometry_continuity_bridge.md b/docs/geometry/geometry_continuity_bridge.md
new file mode 100644
index 0000000..b1c3f11
--- /dev/null
+++ b/docs/geometry/geometry_continuity_bridge.md
@@ -0,0 +1,74 @@
+# Geometry → Continuity Layer Bridge
+
+## Cel
